export const WrapXNative = [
  ...
  {
      "type": "event",
      "name": "PerTokenRewardUpdated",
      "inputs": [
          {
              "name": "newPerTokenReward",
              "type": "uint256",
              "indexed": false,
              "internalType": "uint256"
          }
